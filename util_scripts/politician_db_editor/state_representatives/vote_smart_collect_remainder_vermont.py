...
vt_districts = ["Chitteden", "Bennington", "Rutland", "Windham", "Washington", "Franklin", "Orange", "Caledonias", "Addison", "Windsor Orange", "Windsor"]
...
def search_for_matching_vs_cand( sql_cand, sorted_vs_cand_list):
    ...
    for j in range( 0 , len( sorted_vs_cand_list ) ):
        ...
        if sql_cand["DistrictName"].lower() in vs_cand["officeDistrictName"].lower():
            ...
            if sql_cand["District"] ==  vs_cand["officeDistrictNumber"]:
...
for key,value in name_2_abbrev.items():
    ...
    try:
        ...
        # Parse results
        vs_cand_list = json_results['candidateList']['candidate']
                ...
                try:
                    ...
                    if candidate["officeName"] == "State House":
                        ...
                        if district in candidate["officeDistrictName"]:
                            ...
                            candidate["officeDistrictNumber"] = int(candidate["officeDistrictName"].split()[-1])
